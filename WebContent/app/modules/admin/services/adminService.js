(function() {
	angular.module(APP_NAME).service('AdminService', 
			[ '$http', 'ADMIN_CONSTANT','serverURLFactory','sessionFactory', 
			  function($http,ADMIN_CONSTANT,serverURLFactory,sessionFactory) {
